    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold">ItemVault</h3>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your premier destination for discovering amazing items from trusted sellers worldwide. 
              Modern design meets seamless functionality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/" className="hover:text-white transition-colors">Browse Items</Link></li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} ItemVault. All rights reserved. Built with Next.js, Tailwind CSS & Framer Motion.</p>
        </div>
      </div>
    </motion.footer>
  );
